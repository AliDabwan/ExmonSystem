...
namespace ExmonSystem.Acc
{
    partial class FrmDestination
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.TxtID.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.destinationBindingSource, "Id", true));
            this.TxtID.Name = "TxtID";
            // 
            // destinationBindingSource
            // 
            this.destinationBindingSource.DataSource = typeof(ExmonSystem.Models.Destination);
            // 
            // label1
            // 
            ...
            // driverBindingSource
            // 
            this.driverBindingSource.DataSource = typeof(ExmonSystem.Models.Driver);
            // 
            // panel2
            // 
            ...
            this.tableLayoutPanel1.Controls.Add(this.checkEdit1, 1, 2);
            ...
            this.TxtName.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.destinationBindingSource, "Name", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
            ...
            this.checkEdit1.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.destinationBindingSource, "IsVisa", true));
            ...
            this.DgvRecords.DataSource = this.destinationBindingSource;
