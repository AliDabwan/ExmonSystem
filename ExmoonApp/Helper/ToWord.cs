...
//        public void TONUMS()
//        {
//           = new SqlConnection(@"Data Source=SQL5009.myASP.NET;
//Initial Catalog=DB_A15CE7_mydb;
//User Id=DB_A15CE7_mydb_admin;
//Password=;");
//        }
        private string GetDecimalValue(string decimalPart)
        {
            ...
            {
            //    System.Windows.Forms.MessageBox.Show("parts are      "+Currency.PartPrecision.ToString());//2
            //    System.Windows.Forms.MessageBox.Show( "lenght  "+decimalPart.Length.ToString());//1

            //    System.Windows.Forms.MessageBox.Show(decimalPart.Substring(0, Currency.PartPrecision));//1

            //    System.Windows.Forms.MessageBox.Show(decimalPart.Substring(Currency.PartPrecision, decimalPart.Length - Currency.PartPrecision));
        ...
        public string ConvertToArabic()
        {
            ...
            while (tempNumber >= 1)
            {
                ...
                string groupDescription = ProcessArabicGroup(numberToProcess, group, Math.Floor(Convert.ToDecimal( tempNumber)));
