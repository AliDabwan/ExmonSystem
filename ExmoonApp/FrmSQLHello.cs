...
{
    public partial class FrmSQLHello : DevExpress.XtraEditors.XtraForm
    {
        public FrmSQLHello()
        {
            InitializeComponent();
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            string ConnectionString = "";
                ...
                ConnectionString = string.Format("Data Source={0};Initial Catalog={1};Integrated Security=true", @"(localdb)\MSSQLLocalDB", "ExmonSystemDB");
