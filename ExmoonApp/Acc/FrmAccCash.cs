...
{
    public partial class FrmAccCash : DevExpress.XtraEditors.XtraForm
    {
        ...
        private async void FrmAccCash_Load(object sender, EventArgs e)
        {
            ...
            if (formType == "Cash")
            {
                ...
                {
                    LblTitle.Text = "إضافة نوع دفع";

                }
                else
                {
                    LblTitle.Text = "Add Payment Type";
